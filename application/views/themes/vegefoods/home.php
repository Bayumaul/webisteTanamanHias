...
<section id="home-section" class="hero">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Tanaman Hias Terbaik</h1>
            <h2 class="subheading mb-4">TANAMAN YANG LANGSUNG DIKIRIM OLEH PENJUAL</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">KAMI MENYEDIAKAN DEKORASI</h1>
            <h2 class="subheading mb-4">DEKORASI UNTUK MEMPERCANTIK RUANGAN MAUPUN KAFE</h2>
  ...
  <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg123.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">KAMI MEMBERIKAN TIPS AND TRIK TANAMAN HIAS</h1>
            <h2 class="subheading mb-4">Kami menyediakan berbagai macam tips and trik untuk membuat hidup anda lebih berarti</h2>
            <p><a href="<?php echo site_url('pages/artikel'); ?>" class="btn btn-primary">Baca Sekarang</a></p>
          </div>
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
        <span class="subheading">Produk dan Jasa Terbaru</span>
