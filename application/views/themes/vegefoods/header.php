	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item"><a href="<?php echo site_url('pages/artikel'); ?>" class="nav-link">Tips and Trik</a></li>
			<!--link jasa dan tips and trik belum jadi--> 
		
			 <li class="nav-item"><a href="<?php echo site_url('pages/home'); ?>" class="nav-link">Layanan Jasa</a></li>
